...
type PaymentServiceClient interface {
	...
	// Пополнить счет
	Deposit(ctx context.Context, in *DepositRequest, opts ...grpc.CallOption) (*AccountResponse, error)
	// Получить баланс
	GetBalance(ctx context.Context, in *GetBalanceRequest, opts ...grpc.CallOption) (*AccountResponse, error)
}
...
func (c *paymentServiceClient) Deposit(ctx context.Context, in *DepositRequest, opts ...grpc.CallOption) (*AccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AccountResponse)
...
func (c *paymentServiceClient) GetBalance(ctx context.Context, in *GetBalanceRequest, opts ...grpc.CallOption) (*AccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AccountResponse)
...
type PaymentServiceServer interface {
	...
	// Пополнить счет
	Deposit(context.Context, *DepositRequest) (*AccountResponse, error)
	// Получить баланс
	GetBalance(context.Context, *GetBalanceRequest) (*AccountResponse, error)
...
func (UnimplementedPaymentServiceServer) Deposit(context.Context, *DepositRequest) (*AccountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Deposit not implemented")
}
func (UnimplementedPaymentServiceServer) GetBalance(context.Context, *GetBalanceRequest) (*AccountResponse, error) {
